...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_bumper2pc_SOURCE_PREFIX /home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki/kobuki_bumper2pc)
  set(kobuki_bumper2pc_DEVEL_PREFIX /home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/devel)
  ...
  set(kobuki_bumper2pc_INSTALL_PREFIX /home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/install)
...
if(NOT "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki/kobuki_bumper2pc/include " STREQUAL " ")
  set(kobuki_bumper2pc_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki/kobuki_bumper2pc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_bumper2pc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki/kobuki_bumper2pc/${idir}'.  Ask the maintainer 'Jorge Santos Simon <jorge@yujinrobot.com>' to fix it.")
    endif()
