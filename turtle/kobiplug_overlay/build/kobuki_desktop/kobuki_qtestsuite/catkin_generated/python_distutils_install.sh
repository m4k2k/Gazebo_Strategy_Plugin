...
echo_and_run cd "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki_desktop/kobuki_qtestsuite"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/build/kobuki_desktop/kobuki_qtestsuite" \
    install \
    $DESTDIR_ARG \
