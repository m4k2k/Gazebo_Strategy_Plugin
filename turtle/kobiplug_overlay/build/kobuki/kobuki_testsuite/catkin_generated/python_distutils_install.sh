...
echo_and_run cd "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/ubu/Gazebo_Strategy_Plugin/turtle/kobiplug_overlay/build/kobuki/kobuki_testsuite" \
    install \
    $DESTDIR_ARG \
